...
# Добавьте предложение where, чтобы выбрать только записи, не относящиеся к мужчинам, из Статграда, используя and_
stmt = stmt.where(
...
# Повторите цикл над результирующим запросом, печатающим возраст и пол
